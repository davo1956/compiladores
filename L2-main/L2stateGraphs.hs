...
--
grafOfL2progFrom :: Prog -> [EstadoVT] -> StateGraph
-- Dados:
--      un programa de L2, p=(progName, varList, stm),
...
grafOfL2progFrom (Prog (_, _, stm)) initStates
